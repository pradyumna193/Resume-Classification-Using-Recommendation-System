...
#coverting docx or pdf file to a text
...
#adding extractded text to a resume
...
#here we are doing text preprocessing
...
#creating new dataframe with three neacassry column
...
#reading and uploading docx file 
...
#cheaking length of each column which is > 0 or not 
if len(predicted) > 0:
...
#creating separte section for selecting particular resume type
